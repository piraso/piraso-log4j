...
@ActionID(category = "Window", id = "org.piraso.ui.log4j.Log4jEntryViewTopComponent")
@ActionReference(path = "Menu/Window", position = 336)
@ConvertAsProperties(dtd = "-//org.piraso.ui.log4j//Log4jEntryView//EN", autostore = false)
@TopComponent.Description(preferredID = "Log4jEntryViewTopComponent", iconBase= "org/piraso/ui/log4j/icons/log4j.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS)
